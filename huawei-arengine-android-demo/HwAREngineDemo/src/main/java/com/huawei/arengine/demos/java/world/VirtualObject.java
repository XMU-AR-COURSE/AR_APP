...
public class VirtualObject {
    private static final float ROTATION_ANGLE = 0f;//设置为0，模型不旋转
    ...
    /*
     *使用的obj模型为正常人大小的100倍,为了便于显示，缩小100后再缩小一倍，故模型放大0.005倍
     */
    ...
    private void init() {
        ...
        setColor(new float[]{245.0f, 183.0f, 155.0f, 255.0f});  //改变颜色，设置为肤色
